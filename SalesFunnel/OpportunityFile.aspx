...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server" Tag="MainContent">
    ...
    <asp:Panel ID="pnlView" runat="server" BackColor="White" BorderColor="Black" Visible="false" Width="1200px">
        <asp:Table id="tblOpportunity" runat="server" Width="100%">
            <asp:TableRow>
            <asp:TableCell ColumnSpan="1" Width="200px"><asp:Label ID="lblAction" runat="server" Text="View Opportunity" Font-Size="Large" Font-Bold="True" ForeColor="Black" /></asp:TableCell><asp:TableCell ColumnSpan="1" Width="250px"></asp:TableCell><asp:TableCell ColumnSpan="1" Width="225px"></asp:TableCell><asp:TableCell ColumnSpan="1" Width="225px"></asp:TableCell><asp:TableCell ColumnSpan="1" Width="325px" HorizontalAlign="Right">
            ...
            <asp:TableCell ColumnSpan="2" VerticalAlign="Top"><asp:Label ID="lblHierarchyEdit" runat="server" Text="Industry Hierarchy: " Font-Bold="True" ForeColor="Black" Width="325px" /></asp:TableCell><asp:TableCell ColumnSpan="2" VerticalAlign="Top"><asp:Label ID="lblCustomerEdit" runat="server" Text="Customer: " Font-Bold="True" ForeColor="Black" /></asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblOpportunityEdit" runat="server" Text="Opportunity: " Font-Bold="True" ForeColor="Black" /></asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell ColumnSpan="2" VerticalAlign="Top"><asp:TextBox ID="lblDsplyHierarchyEdit" runat="server" BackColor="White" width="98%" Enabled="False"></asp:TextBox></asp:TableCell><asp:TableCell ColumnSpan="2" VerticalAlign="Top"><asp:DropDownList ID="ddlCustomerEdit" runat="server" width="400px" Enabled="False" /><asp:Button ID="btnAddProspect" runat="server" Text="Add" Visible="False" /> </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:TextBox ID="txtOpportunityEdit" runat="server" width="445px" Enabled="False" Tag="X" /></asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblFunnelPhaseEdit" runat="server" Text="Funnel Phase: " Font-Bold="True" ForeColor="Black" /></asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblCloseDateEdit" runat="server" Text="Close Date:" Font-Bold="True" ForeColor="Black" /></asp:TableCell><asp:TableCell ColumnSpan="2" VerticalAlign="Top"><asp:Label ID="lblOpportunityComment" runat="server" Text="Opportunity Comment:" Font-Bold="True" ForeColor="Black" /></asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblOpportunityDetail" runat="server" Text="Opportunity Detail: " Font-Bold="True" ForeColor="Black" /></asp:TableCell></asp:TableRow><asp:TableRow>
            ...
            <asp:TableCell ColumnSpan="1" RowSpan="7"  VerticalAlign="Top" HorizontalAlign="Left"><asp:Calendar ID="calCloseDateEdit" runat="server"> </asp:Calendar>  </asp:TableCell><asp:TableCell ColumnSpan="2" RowSpan="7"  VerticalAlign="Top">
            ...
            </asp:TableCell><asp:TableCell ColumnSpan="1" RowSpan="12" VerticalAlign="Top">
            ...
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblPSValueEdit" runat="server" Text="PS Value: " Font-Bold="True" ForeColor="Black" /></asp:TableCell></asp:TableRow><asp:TableRow>
            ...
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblWinPercentEdit" runat="server" Text="Win Percent: " Font-Bold="True" ForeColor="Black" /></asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top">
            ...
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblOutlookStatus" runat="server" Text="Outlook Status:" Font-Bold="True" ForeColor="Black" /></asp:TableCell></asp:TableRow><asp:TableRow>
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblMPOverrideEdit" runat="server" Text="MP Override Status:" Font-Bold="True" ForeColor="Black" /></asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblOrderFlowEdit" runat="server" Text="Order Flow:" Font-Bold="True" ForeColor="Black" /></asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell></asp:TableRow><asp:TableRow>
            ...
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblRevenueUpsideEdit" runat="server" Text="Revenue Upside: " Font-Bold="True" ForeColor="Black" /></asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:Label ID="lblOpportunityStatusEdit" runat="server" Text="Opportunity Status: " Font-Bold="True" ForeColor="Black" /></asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top">
            ...
            </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top"><asp:DropDownList ID="ddlOpportunityStatusEdit" runat="server" width="150px" Enabled="False" /></asp:TableCell>
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell><asp:TableCell ColumnSpan="1" VerticalAlign="Top">&nbsp; </asp:TableCell></asp:TableRow></asp:Table></asp:Panel></asp:Content>