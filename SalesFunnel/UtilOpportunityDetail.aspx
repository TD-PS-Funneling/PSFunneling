<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="UtilOpportunityDetail.aspx.vb" Inherits="UtilOpportunityDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Panel ID="pnlOpportunityTypeList" runat="server">
        <div class="Table">
            <div class="Row">
                <div class="leftCellUtil">
                    <a id="lnkadd" onclick="addResource()" style="cursor: pointer;">Add Opportunity Detail</a>
                </div>
                <div class="leftCellUtil">
                    <a id="lnkdelete" onclick="deleteResource()" style="cursor: pointer;">Delete Opportunity Detail</a>
  
                </div>
                <div class="RightCellUtil">
        ...
        <div style="clear:both">
            <asp:GridView ID="gvOpportunity" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" EmptyDataText="No Record Found" PageSize="15" Width ="100%"
    ...
    <asp:Panel ID="pnlOpportunityTypeDetail" runat="server">
        <div class="Table">
            <div class="Row">
                <div class="ActionButtonCell">
                    <!-- BUTTONS -->
                     <asp:Button ID="btnDelete" runat="server" Text="Delete" OnClientClick='return confirm("Are you sure you want to delete this item?")'/>
        ...
        <div class ="Table">
            ...
            <div class ="Row">
                ...
                <div class="RightCellUtil">
                    <asp:DropDownList ID ="ddlDetailVis" runat="server">
